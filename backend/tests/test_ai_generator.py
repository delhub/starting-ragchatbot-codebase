...
class TestGenerateResponseWithoutTools:
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_generate_response_no_history(self, mock_anthropic_class, test_config,
                                         mock_anthropic_response_no_tool):
...
class TestGenerateResponseWithTools:
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_generate_response_with_tools_no_use(self, mock_anthropic_class, test_config,
                                                 mock_anthropic_response_no_tool,
                                                 mock_tool_manager):
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_generate_response_triggers_tool_use(self, mock_anthropic_class, test_config,
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_tool_choice_auto_when_tools_provided(self, mock_anthropic_class, test_config,
                                                  mock_anthropic_response_no_tool,
                                                  mock_tool_manager):
...
class TestHandleToolExecution:
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_tool_execution_flow(self, mock_anthropic_class, test_config,
                                 mock_anthropic_response_with_tool,
                                 mock_anthropic_final_response,
                                 mock_tool_manager):
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_tool_results_added_to_messages(self, mock_anthropic_class, test_config,
                                           mock_anthropic_response_with_tool,
                                           mock_anthropic_final_response,
                                           mock_tool_manager):
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_tools_available_until_max_rounds(self, mock_anthropic_class, test_config,
                                              mock_anthropic_response_with_tool,
                                              mock_anthropic_final_response,
                                              mock_tool_manager):
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_multiple_tool_calls_in_response(self, mock_anthropic_class, test_config,
                                             mock_anthropic_final_response,
                                             mock_tool_manager):
...
class TestSystemPrompt:
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_system_prompt_includes_base_instructions(self, mock_anthropic_class, test_config,
                                                      mock_anthropic_response_no_tool):
...
class TestSequentialToolCalling:
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_two_sequential_tool_calls(self, mock_anthropic_class, test_config,
                                       mock_tool_manager):
        ...
        mock_response_1.content = [create_mock_tool_use(
        ...
        mock_response_2.content = [create_mock_tool_use(
            "search_course_content",
            {"query": "computer use"},
            "tool_2"
        )]
        ...
        mock_content.text = "Both prompt caching and computer use are powerful features."
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_max_rounds_limit_enforced(self, mock_anthropic_class, test_config,
                                       mock_tool_manager):
        ...
        mock_tool_response.content = [create_mock_tool_use(
            "search_course_content",
            {"query": "test"},
            "tool_test"
        )]
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_early_termination_on_final_response(self, mock_anthropic_class,
                                                 test_config, mock_tool_manager):
    ...
    @patch('ai_generator.anthropic.Anthropic')
    def test_message_history_accumulates_correctly(self, mock_anthropic_class,
                                                   test_config, mock_tool_manager):
